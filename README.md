...
**Architecture Flow:**
```
User (WhatsApp) ──► n8n Trigger
       │
       ▼
NLP → SQL Generator (LLM)
       │
       ▼
SQL Executor (DB Layer)
       │
       ▼
...
<img src="https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExd2hmeWV5dWZhNm55anZ5cDBid2Q1bXJzd2t3dTBrb2NieWxjcGNhciZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/qgQUggAC3Pfv687qPC/giphy.gif" width="260" alt="Automation"/>
...
### 🥇 `[2]` E-Commerce Web App + Analytics Dashboard (Flask + LLM + MySQL)

<table>
<tr>
<td width="40%" align="center">

<img src="https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExcGw0dGQ2ZWdnaHVsZzJ3dW56b3ZwMnk4a2I5bW9kY3pkdzZwNmVwbiZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/26tn33aiTi1jkl6H6/giphy.gif" width="260" alt="Dashboard"/>

<br/>

![Flask](https://img.shields.io/badge/Flask-Backend-00ff9c?style=flat-square&labelColor=0a0a0a)
![MySQL](https://img.shields.io/badge/MySQL-Connector-00ff9c?style=flat-square&labelColor=0a0a0a)
![LLM](https://img.shields.io/badge/LLM-API-00ff9c?style=flat-square&labelColor=0a0a0a)
![Python](https://img.shields.io/badge/Python-Core-00ff9c?style=flat-square&labelColor=0a0a0a)

</td>
<td width="60%">

**Full-stack e-commerce platform with built-in AI analytics.**

A production-grade e-commerce web application with a **dedicated analytics tab** powered by LLM insights. Built with Flask + Python backend, MySQL Connector for data persistence, and an integrated LLM API that auto-interprets sales trends, customer behavior, and inventory patterns.

**Key Features:**
```
✅ Full product catalog, cart & checkout flow
✅ User auth + session management
✅ MySQL-backed orders, products & users
✅ Analytics Tab:
   ├── Real-time sales charts & KPIs
   ├── Customer behavior patterns
   ├── LLM-powered insight summaries
   └── Inventory & revenue forecasting
```

**Stack:** Python · Flask · MySQL Connector · LLM API · Chart.js · HTML/CSS/JS
...
### 🥇 `[3]` AWS Data Pipeline → Snowflake → Streamlit Dashboard
...
<img src="https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExaTEwMzlpcHRlZGVpdndxOWs5cjVydGZhcjYzaG9yajcxZzBiN3ZjbyZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/xT9IgzoKnwFNmISR8I/giphy.gif" width="260" alt="Cloud Pipeline"/>

<br/>

![AWS S3](https://img.shields.io/badge/AWS_S3-Storage-00ff9c?style=flat-square&labelColor=0a0a0a)
![Snowflake](https://img.shields.io/badge/Snowflake-Warehouse-00ff9c?style=flat-square&labelColor=0a0a0a)
![Streamlit](https://img.shields.io/badge/Streamlit-Dashboard-00ff9c?style=flat-square&labelColor=0a0a0a)
![Python](https://img.shields.io/badge/Python-ETL-00ff9c?style=flat-square&labelColor=0a0a0a)
...
### 🥇 `[4]` Chicken Coccidiosis Detector — End-to-End DL + MLOps Pipeline

<table>
<tr>
<td width="40%" align="center">

<img src="https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExNWFsbWU1enUycmQ3MjNib3VvNXVtMnB5eDFzMjZ6ZHNlaHJzZzl5OSZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/LaVp0AyqR5bGsC5Cbm/giphy.gif" width="260" alt="Deep Learning"/>

<br/>

![PyTorch](https://img.shields.io/badge/PyTorch-CNN-00ff9c?style=flat-square&labelColor=0a0a0a)
![MLOps](https://img.shields.io/badge/MLOps-Full_Pipeline-00ff9c?style=flat-square&labelColor=0a0a0a)
![DVC](https://img.shields.io/badge/DVC-Data_Version-00ff9c?style=flat-square&labelColor=0a0a0a)
![Docker](https://img.shields.io/badge/Docker-Deployed-00ff9c?style=flat-square&labelColor=0a0a0a)

</td>
<td width="60%">

**Real-world Deep Learning + full MLOps lifecycle. Deployed.**

An end-to-end disease detection system that classifies chicken fecal images as **Coccidiosis** or **Healthy** using a CNN-based deep learning model. This project covers the **complete ML lifecycle** — from raw data collection all the way to containerized deployment.

**Full MLOps Pipeline:**
```
Data Collection & Versioning (DVC)
    │
    ▼
Image Preprocessing & Augmentation
    │
    ▼
CNN Model Training (Transfer Learning)
    │
    ▼
...
**Why it matters:** Applies Deep Learning to solve a real agricultural problem. Full MLOps — not just a Jupyter notebook.
...
<!-- Anime celebration GIF -->
<img src="https://media.giphy.com/media/wvQIqJyNBOCjK/giphy.gif" width="100" title="That's the power of AI!"/>
...
<img src="https://img.shields.io/badge/Streamlit-00ff9c?style=for-the-badge&logo=streamlit&logoColor=0a0a0a&labelColor=0a0a0a"/>
...
<img src="https://img.shields.io/badge/MLflow-00ff9c?style=for-the-badge&logo=mlflow&logoColor=0a0a0a&labelColor=0a0a0a"/>
<img src="https://img.shields.io/badge/DVC-00ff9c?style=for-the-badge&logo=dvc&logoColor=0a0a0a&labelColor=0a0a0a"/>
</p>
...
> 🔴 = Flagship Priority Projects &nbsp;|&nbsp; ⭐ = High Impact &nbsp;|&nbsp; 🔥 = Production Agentic Systems
